          ...
          <div className=" w-full h-full shadow-xl shadow-black rounded-xl p-4">
            <div className="lg:p-4 h-full ">
              ...
              <div className="text-[#dcdbdb]">
                ...
                <p className="py-4">
                  I am looking for Full-Time / Freelance / Contract Software
              ...
              <div>
                ...
                <div className="flex items-center justify-between py-4">
                  ...
                  <a
                    href="mailto:rjadharsh333@gmail.com"
                    className="rounded-full shadow-lg shadow-black p-6 cursor-pointer hover:scale-110 ease-in duration-300"
                  >
