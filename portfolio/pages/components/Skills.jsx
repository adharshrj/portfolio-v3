...
import { Html, Css, Javascript, Python, ReactImg, Tailwind, Github, Firebase, NextJS, NodeJS, mongo, AWS, Supabase, GitLab, Java, spring, mysql, Azure } from "./helpers/assets";
const Skills = () => {
  return (
      ...
      <div className="max-w-[1240px] mx-auto flex flex-col justify-center h-full">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300">
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
              <div className="m-auto">
                <Image src={spring} width="64" height="64" alt="/" />
              </div>
              <div className="flex flex-col items-center justify-center">
                <h3>Spring Boot</h3>
              </div>
          ...
          <div className="p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300">
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
              <div className="m-auto">
                <Image src={Supabase} width="64" height="64" alt="/" />
              </div>
              <div className="flex flex-col items-center justify-center">
                <h3>Supabase</h3>
              </div>
