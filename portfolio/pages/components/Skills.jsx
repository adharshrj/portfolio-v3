  ...
  return (
    <div id="skills" className="w-full px-4 lg:h-screen">
      <div className="max-w-[1240px] mx-auto flex flex-col justify-center h-full">
        ...
        <p className="font-extrabold text-xl tracking-widest uppercase text-[#3b95da] py-4"> Frontend</p>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-[#dcdbdb]">
          {frontendlist}
        </div>
        <p className="font-extrabold text-xl tracking-widest uppercase text-[#3b95da] py-4"> Backend</p>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-[#dcdbdb]">
          {backendlist}
        </div>
        <p className="font-extrabold text-xl tracking-widest uppercase text-[#3b95da] py-4"> Database</p>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-[#dcdbdb]">
          {dblist}
        </div>
        <p className="font-extrabold text-xl tracking-widest uppercase text-[#3b95da] py-4"> Platform</p>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-[#dcdbdb]">
          {otherlist}
        </div>
      </div>
